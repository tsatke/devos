...
use crate::driver::pci::raw::{
    ...
    OFFSET_INTERRUPT_PIN, OFFSET_PROG_IF, OFFSET_REVISION_ID, OFFSET_STATUS, OFFSET_SUBCLASS,
    OFFSET_SUBSYSTEM_ID, OFFSET_SUBSYSTEM_VENDOR_ID, OFFSET_VENDOR_ID, read_config_half_word,
    read_config_word,
};
