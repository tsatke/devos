...
impl Deref for BaseAddressRegister {
    type Target = PciRegister<u32>;
...
impl DerefMut for BaseAddressRegister {
    fn deref_mut(&mut self) -> &mut Self::Target {
        &mut self.0
    }
}

impl From<PciRegister<u32>> for BaseAddressRegister {
    fn from(value: PciRegister<u32>) -> Self {
        Self(value)
    }
}
